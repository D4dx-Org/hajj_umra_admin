...
const UmrahSteps = () => {
  ...
  const API_URL = `${import.meta.env.VITE_BACKEND_URL_V2}/umrah-umrah-steps`;
  ...
  const handleDownloadTemplate = async () => {
    try {
      ...
      link.href = url;
      link.setAttribute("download", "umrahsteps_template.xlsx");
  ...
  const columns = [
    ...
    },
    {
      ...
      title: "stepNumber",
      render: (row) => (
        <span className="truncate" title={row.stepNumber || '-'}>
          {row.stepNumber || '-'}
        </span>
      ),
    },
      ...
      title: "dua",
      render: (row) => (
        <span className="truncate" title={row.dua || '-'}>
          {row.dua || '-'}
        </span>
      ),
    },
        ...
        render: (row) => (
          row.locationMap ? (
            <a href={row.locationMap} target="_blank" rel="noopener noreferrer" className="inline-block">
  ...
  return (
    <div>
      ...
      <p className="text-gray-900">{`${selectedItem.title || 'Not provided'}`}</p>
              ...
              <div>
      <label className="block text-sm font-medium text-gray-600 mb-1">stepNumber</label>
      <p className="text-gray-900">{`${selectedItem.stepNumber || 'Not provided'}`}</p>
    </div>
              <div>
      ...
      <p className="text-gray-900">{`${selectedItem.description || 'Not provided'}`}</p>
              ...
              <div>
      <label className="block text-sm font-medium text-gray-600 mb-1">dua</label>
      <p className="text-gray-900">{`${selectedItem.dua || 'Not provided'}`}</p>
    </div>
              <div>
        ...
        {selectedItem.image && Array.isArray(selectedItem.image) && selectedItem.image.length > 0 ? (
          ...
          <p className="text-gray-500">No images available</p>
              ...
              <div>
        <label className="block text-sm font-medium text-gray-600 mb-1">videoUrl</label>
        {selectedItem.videoUrl ? (
          <div className="space-y-2">
            ...
            {(() => {
              ...
              <div>
        <label className="block text-sm font-medium text-gray-600 mb-1">locationMap</label>
        {selectedItem.locationMap ? (
          <div className="space-y-2">
            <a href={selectedItem.locationMap} target="_blank" rel="noopener noreferrer">
              <Button size="small" icon={<MapPin size={14} />}>
                View on Map
              </Button>
            </a>
            <div className="text-sm text-gray-600 break-all">
              <a href={selectedItem.locationMap} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline">
                {selectedItem.locationMap}
              </a>
            </div>
          </div>
        ...
        >
          ...
          <Form.Item name="stepNumber" label="stepNumber">
          <Input type="number" placeholder="Enter stepNumber" />
        </Form.Item>
          <Form.Item name="description" label="description">
          <TextArea rows={4} placeholder="Enter description" />
        </Form.Item>
          <Form.Item name="dua" label="dua">
          <TextArea rows={4} placeholder="Enter dua" />
        </Form.Item>
          ...
          <Form.Item name="videoUrl" label="YouTube Video URL" rules={[
          ...
          <Form.Item name="locationMap" label="Map Link URL" rules={[{ type: "url", message: "Please enter a valid URL" }]}>
