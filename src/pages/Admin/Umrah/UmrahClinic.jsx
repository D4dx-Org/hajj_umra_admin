...
const UmrahClinic = ({ isOpen }) => {
  ...
  const clinicColumns = [
    ...
    },
    {
      key: "center",
      title: "Center",
      render: (row) => <span className="truncate" title={row.center || "N/A"}>{row.center || "N/A"}</span>,
    },
    {
      key: "malayalamCenter",
      title: "Ml Center",
      render: (row) => <span className="truncate" title={row.malayalamCenter || "-"}>{row.malayalamCenter || "-"}</span>,
    },
    {
      key: "urduCenter",
      title: "Ur Center",
      render: (row) => <span className="truncate" title={row.urduCenter || "-"}>{row.urduCenter || "-"}</span>,
    },
    {
      key: "poll",
      title: "Poll",
    ...
    },
    {
      key: "malayalamPoll",
      title: "Ml Poll",
      render: (row) => <span className="truncate" title={row.malayalamPoll || "-"}>{row.malayalamPoll || "-"}</span>,
    },
    {
      key: "urduPoll",
      title: "Ur Poll",
      render: (row) => <span className="truncate" title={row.urduPoll || "-"}>{row.urduPoll || "-"}</span>,
    },
    {
      key: "location",
      title: "Location",
                  ...
                  {clinicColumns.map((column) => (
                    <th
                      ...
                      className={`px-2 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider ${
                        ...
                        column.key === 'malayalamCenter' ? 'w-20' :
                        column.key === 'urduCenter' ? 'w-20' :
                        column.key === 'poll' ? 'w-16' :
                        column.key === 'malayalamPoll' ? 'w-20' :
                        column.key === 'urduPoll' ? 'w-20' :
                        column.key === 'location' ? 'w-24' :
                        column.key === 'branchRef' ? 'w-20' :
                        ...
                        {clinicColumns.map((column) => (
                          <td
                            ...
                            className={`px-2 py-2 text-sm text-gray-900 ${
                              ...
                              column.key === 'malayalamCenter' ? 'max-w-20 truncate' :
                              column.key === 'urduCenter' ? 'max-w-20 truncate' :
                              column.key === 'poll' ? 'max-w-16 truncate' :
                              column.key === 'malayalamPoll' ? 'max-w-20 truncate' :
                              column.key === 'urduPoll' ? 'max-w-20 truncate' :
                              column.key === 'location' ? 'max-w-24 truncate' :
                              column.key === 'branchRef' ? 'max-w-20 truncate' :
