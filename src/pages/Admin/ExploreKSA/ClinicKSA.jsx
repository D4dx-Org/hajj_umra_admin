...
//       try {
//         const response = await axios.get(`${import.meta.env.VITE_BACKEND_URL_V2}/clinic`);
...
//         `${import.meta.env.VITE_BACKEND_URL_V2}/clinic/${row._id}`,
//         row,
//         {
//           headers: {
...
//         axios.delete(`${import.meta.env.VITE_BACKEND_URL_V2}/clinic/${id}`, {
//           headers: {
//             Authorization: `Bearer ${token}`,
//           },
//         })
...
//         `${import.meta.env.VITE_BACKEND_URL_V2}/clinic`,
//         newClinic,
//         {
//           headers: {
//             Authorization: `Bearer ${token}`,
...
//         const updatedResponse = await axios.get(`${import.meta.env.VITE_BACKEND_URL_V2}/clinic`);
...
//             const locationExists = locations.some(location => location.title.toLowerCase() === row.location_name.toLowerCase());
//             if (!locationExists) {
...
//           const response = await axios.post(
//             `${import.meta.env.VITE_BACKEND_URL_V2}/clinic/bulk-upload`,
//             formData,
//             {
//               headers: {
//                 Authorization: `Bearer ${token}`,
          ...
          <div className="bg-white rounded-lg p-6 max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="space-y-4">
                <h4 className="font-semibold text-lg text-blue-600 border-b pb-2">Name Information</h4>
                <div>
                  <label className="block text-sm font-medium text-gray-700">Name (English)</label>
                  <p className="mt-1 text-gray-900">{selectedRowData.name || 'N/A'}</p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700">Name (Malayalam)</label>
                  <p className="mt-1 text-gray-900">{selectedRowData.nameMalayalam || 'N/A'}</p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700">Name (Urdu)</label>
                  <p className="mt-1 text-gray-900" dir="rtl">{selectedRowData.nameUrdu || 'N/A'}</p>
                </div>
              </div>

              <div className="space-y-4">
                <h4 className="font-semibold text-lg text-blue-600 border-b pb-2">Center Information</h4>
                <div>
                  <label className="block text-sm font-medium text-gray-700">Center (English)</label>
                  <p className="mt-1 text-gray-900">{selectedRowData.center || 'N/A'}</p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700">Center (Malayalam)</label>
                  <p className="mt-1 text-gray-900">{selectedRowData.centerMalayalam || 'N/A'}</p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700">Center (Urdu)</label>
                  <p className="mt-1 text-gray-900" dir="rtl">{selectedRowData.centerUrdu || 'N/A'}</p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-gray-900">{selectedRowData.ref?.title || 'N/A'}</p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700">Branch Reference</label>
                  <p className="mt-1 text-gray-900">{selectedRowData.branchRef?.name || 'N/A'}</p>
                </div>
              </div>
            </div>
