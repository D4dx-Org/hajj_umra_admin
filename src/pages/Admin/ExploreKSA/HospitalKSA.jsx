...
//           nameMalayalam: 'സാമ്പിൾ ആശുപത്രി (Optional)',
//           nameUrdu: 'نمونہ ہسپتال (Optional)',
        ...
        <div className="fixed inset-0 bg-transparent backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-2xl font-bold">Hospital Details</h3>
              <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-gray-900" dir="rtl">{selectedRowData.arabicName || 'N/A'}</p>
                </div>
              </div>

              <div className="space-y-4">
                <h4 className="font-semibold text-lg text-blue-600 border-b pb-2">Contact Information</h4>
                <div>
                  <label className="block text-sm font-medium text-gray-700">Phone</label>
                  <p className="mt-1 text-gray-900">{selectedRowData.phone || 'N/A'}</p>
                </div>
                <div>
              ...
              <div className="space-y-4">
                <h4 className="font-semibold text-lg text-blue-600 border-b pb-2">Reference Information</h4>
                <div>
                  <label className="block text-sm font-medium text-gray-700">Location Reference</label>
                  <p className="mt-1 text-gray-900">{selectedRowData.ref?.title || selectedRowData.ref?.name || 'N/A'}</p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700">Branch Reference</label>
                  <p className="mt-1 text-gray-900">{selectedRowData.branchRef?.name || 'No Branch'}</p>
                </div>
              </div>
            </div>
