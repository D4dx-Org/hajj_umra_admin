...
//         title: "Name (Urdu)",
//         render: (row) => (
//           <span className="truncate" title={row.nameUrdu || "-"} dir="rtl">
//             {row.nameUrdu || "-"}
//           </span>
//         ),
//       },
...
//         title: "Contact",
//         render: (row) => (
//           <span className="truncate" title={row.contact || "-"}>
//             {row.contact || "-"}
//           </span>
//         ),
//       },
...
//         render: (row) => (
//           <span className="truncate" title={row.ref?.title || row.ref || "-"}>
//             {row.ref?.title || row.ref || "-"}
//           </span>
//         ),
//       },
//       {
...
//         ids.map((id) =>
//           axios.delete(
//             `${import.meta.env.VITE_BACKEND_URL_V2}/emergency/${id}`,
//             {
//               headers: {
//                 Authorization: `Bearer ${token}`,
//               },
        ...
        <div className="fixed inset-0 bg-transparent backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-2xl font-bold">Emergency Contact Details</h3>
              <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-gray-900">{selectedRowData.contact || 'N/A'}</p>
                </div>
                <div>
