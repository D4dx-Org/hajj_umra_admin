...
const Navbar = ({ sidebarOpen, setSidebarOpen, toggleSidebar }) => {
  ...
  const handleToggleSidebar = () => {
    if (toggleSidebar) {
      // Use the old toggleSidebar prop if provided
      toggleSidebar();
    } else if (setSidebarOpen) {
      // Use the new setSidebarOpen prop if provided
